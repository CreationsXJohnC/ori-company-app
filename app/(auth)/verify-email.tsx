        ...
        <View style={{ gap: 12, width: '100%' }}>
          {resent ? (
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              <CheckCircle size={18} color="#7EBF94" />
              <Text style={{ fontFamily: fontFamilies.bodyMedium, fontSize: 14, color: '#7EBF94' }}>
          ...
          >
            <Text style={{ fontFamily: fontFamilies.bodyMedium, fontSize: 15, color: '#7EBF94' }}>
              Back to Sign In
            </Text>
          </TouchableOpacity>
        </View>
